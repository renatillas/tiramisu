...
////   )
//// </script>
//// Generic tween animation system for interpolating values over time.
////
//// Tweens provide smooth transitions between values using easing functions.
//// Unlike model animations (which are Three.js-specific), tweens work with any type:
//// Float, Vec3, Transform, or your custom types.
////
//// ## Quick Example
////
//// ```gleam
...
////
//// // Fade opacity from 0.0 to 1.0 over 2 seconds
//// let fade_tween = tween.tween_float(
////   start: 0.0,
////   end: 1.0,
////   duration: duration.seconds(2),
////   easing: fn(t) { t },  // Linear easing
//// )
////
//// // In your update function
//// fn update(model: Model, msg: Msg, ctx: Context) {
////   let updated_tween = tween.update(model.fade_tween, ctx.delta_time)
////   let current_opacity = tween.get_value(updated_tween)
////
////   case tween.is_complete(updated_tween) {
////     True -> // Fade complete, trigger next action
////     False -> Model(..model, fade_tween: updated_tween)
////   }
//// }
//// ```
