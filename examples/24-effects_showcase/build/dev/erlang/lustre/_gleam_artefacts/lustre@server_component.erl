...
-spec element(
    list(lustre@vdom@vattr:attribute(YSQ)),
    list(lustre@vdom@vnode:element(YSQ))
) -> lustre@vdom@vnode:element(YSQ).
...
-spec include(lustre@vdom@vattr:attribute(YTC), list(binary())) -> lustre@vdom@vattr:attribute(YTC).
...
-spec subject(lustre:runtime(YTG)) -> gleam@erlang@process:subject(lustre@runtime@server@runtime:message(YTG)).
subject(Runtime) ->
...
-spec register_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(YTO))
) -> lustre@runtime@server@runtime:message(YTO).
...
-spec deregister_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(YTS))
) -> lustre@runtime@server@runtime:message(YTS).
...
-spec register_callback(
    fun((lustre@runtime@transport:client_message(YTW)) -> nil)
) -> lustre@runtime@server@runtime:message(YTW).
...
-spec deregister_callback(
    fun((lustre@runtime@transport:client_message(YTZ)) -> nil)
) -> lustre@runtime@server@runtime:message(YTZ).
...
-spec select(
    fun((fun((YUE) -> nil), gleam@erlang@process:subject(any())) -> gleam@erlang@process:selector(YUE))
) -> lustre@effect:effect(YUE).
select(Sel) ->
