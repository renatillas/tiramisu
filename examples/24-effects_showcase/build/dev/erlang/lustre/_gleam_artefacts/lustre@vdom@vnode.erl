...
-type element(RZW) :: {fragment,
        integer(),
        binary(),
        fun((gleam@dynamic:dynamic_()) -> gleam@dynamic:dynamic_()),
        list(element(RZW)),
        lustre@internals@mutable_map:mutable_map(binary(), element(RZW))} |
    {element,
        integer(),
        binary(),
        fun((gleam@dynamic:dynamic_()) -> gleam@dynamic:dynamic_()),
...
?DOC(false).
-spec to_keyed(binary(), element(SAT)) -> element(SAT).
to_keyed(Key, Node) ->
    case Node of
...
-spec fragment(
    ...
    fun((gleam@dynamic:dynamic_()) -> gleam@dynamic:dynamic_()),
    list(element(RZX)),
    lustre@internals@mutable_map:mutable_map(binary(), element(RZX))
) -> element(RZX).
...
-spec element(
    ...
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(SAE)),
    list(element(SAE)),
    lustre@internals@mutable_map:mutable_map(binary(), element(SAE)),
    boolean(),
    boolean()
) -> element(SAE).
element(
