...
-type pool(OZF, OZG) :: {pool,
        fun((OZF, glisten@internal@handler:loop_message(OZG), glisten@internal@handler:connection(OZG)) -> glisten@internal@handler:next(OZF, glisten@internal@handler:loop_message(OZG))),
        integer(),
        fun((glisten@internal@handler:connection(OZG)) -> {OZF,
            gleam@option:option(gleam@erlang@process:selector(OZG))}),
        gleam@option:option(fun((OZF) -> nil)),
        glisten@transport:transport()}.
