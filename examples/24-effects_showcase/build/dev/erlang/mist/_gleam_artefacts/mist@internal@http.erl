...
?DOC(false).
-spec add_date_header(gleam@http@response:response(AACK)) -> gleam@http@response:response(AACK).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(AACN)) -> gleam@http@response:response(AACN).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(AACQ)) -> gleam@http@response:response(AACQ).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(AACT)) -> gleam@http@response:response(AACT).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(AACY)) -> gleam@http@response:response(AACY)).
